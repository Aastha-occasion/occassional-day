...
<body style="background-color:#595959">
    ...
    <br><br><br><br><br>
    <center style="margin-top:10px;margin-bottom:10px;"><font size="7" face="Times New Roman" color="gold" >MENTOR</font></center>
        ...
        <div class="col-md-12" style="display:flex;justify-content:center;">
            <div>
                <div style="display:flex;justify-content:center">
                   <a href="images/ayesha.jpg" style="text-decoration:none">
                    <img src="images/ayesha.jpg" alt="" style="height:300px;width:300px; border-radius:10px;box-shadow:0px 0px 10px 3px;">
                    </a>

                </div>
                <div style="margin-left:15%;margin-top:30px;">
                    <font face="Comic Sans MS" color="orange">NAME:</font>
                    <font  color="white">Miss Ayesha khan</font>

                </div>
                <div style="margin-left:15%;margin-top:5px;">
                    <font face="Comic Sans MS" color="orange">WORK AS:</font>
                    <font  color="white">Instructor</font>

                </div>
                <div style="margin-left:15%;margin-top:5px;">
                    <font face="Comic Sans MS" color="orange">INFO:</font>
                    <font  color="white">she is a computer science engineer <br> and trained students by online courses on UDEMY Site 
                        <br><span style="color:yellow">www.Udemy.com</span></font>
